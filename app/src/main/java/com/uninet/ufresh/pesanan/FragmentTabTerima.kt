...
class FragmentTabTerima : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_tab_terima, container, false)
        recyclerView = view.findViewById(R.id.rv__pesanan__selesai)
        initView()
        return view
    }
    ...
    private fun initView(){
        ...
        addpesananlist.add(PesananStatusModel("Tomat",40000,"Toko bu Hilda","Selesai",2,"kurir : Bpk Argus"))
        addpesananlist.add(PesananStatusModel("Tomat",40000,"Toko bu Hilda","Selesai",2,"kurir : Bpk Argus"))
        addpesananlist.add(PesananStatusModel("Tomat",40000,"Toko bu Hilda","Selesai",2,"kurir : Bpk Argus"))
        addpesananlist.add(PesananStatusModel("Tomat",40000,"Toko bu Hilda","Selesai",2,"kurir : Bpk Argus"))
        addpesananlist.add(PesananStatusModel("Tomat",40000,"Toko bu Hilda","Selesai",2,"kurir : Bpk Argus"))
