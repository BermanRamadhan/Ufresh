...
class FragmentTabBelumBayar : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_tab_belum_bayar, container, false)
        recyclerView = view.findViewById(R.id.rv__pesanan__belum__bayar)
        initView()
    ...
    private fun initView(){
        ...
        addpesananlist.add(PesananStatusModel("Tomat segar dari gunung",40000,"Toko Ibu Hilda","Belum Dibayar",2))
        addpesananlist.add(PesananStatusModel("Tomat segar dari gunung",40000,"Toko Ibu Hilda","Belum Dibayar",2))
        addpesananlist.add(PesananStatusModel("Tomat segar dari gunung",40000,"Toko Ibu Hilda","Belum Dibayar",2))
        addpesananlist.add(PesananStatusModel("Tomat segar dari gunung",40000,"Toko Ibu Hilda","Belum Dibayar",2))
        addpesananlist.add(PesananStatusModel("Tomat segar dari gunung",40000,"Toko Ibu Hilda","Belum Dibayar",2))
        addpesananlist.add(PesananStatusModel("Tomat segar dari gunung",40000,"Toko Ibu Hilda","Belum Dibayar",2))
        addpesananlist.add(PesananStatusModel("Tomat segar dari gunung",40000,
                "Toko Ibu Hilda","Belum Dibayar",2))
    ...
    fun onAction(){
        pesananAdapter.onClickActionButton(object : ActionButton {
            ...
            override fun onClickOpenDetail(item: View, position: Int) {
                ...
                i.putExtra("status",pesananAdapter.getStatus(item))
                startActivity(i)
            }
        })
    }
